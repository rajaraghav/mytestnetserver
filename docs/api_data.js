define({ "api": [
  ...
  },
  {
    "type": "post",
    "url": "/auth/reddit",
    "title": "Authenticate with Reddit",
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "state",
            "description": "<p>Reddit variable passed on login.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "code",
            "description": "<p>Reddit user accessToken.</p>"
          }
        ]
      }
    },
  ...
  },
  {
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "deposit",
            "description": "<p>Deposit's data.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Error 4xx": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "404",
            "description": "<p>Deposit not found.</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
    ...
    "version": "0.0.0",
    "filename": "src/api/deposit/index.js",
    "groupTitle": "Deposit"
  },
  {
    "type": "get",
    "url": "/deposit/update-balance",
    "title": "Retrieve deposit",
    "name": "RetrieveDeposit",
    "group": "Deposit",
    "permission": [
  ...
  {
    "type": "get",
    "url": "/trade/admin/:method",
    "title": "Send root-level request to Xchange",
    "name": "SendRequestAdmin",
    "group": "Trade",
    "permission": [
      {
        "name": "admin",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "method",
            "description": "<p>Xchange server method.</p>"
          },
          {
            "group": "Parameter",
            "type": "Any",
            "optional": false,
            "field": "...",
            "description": "<p>parameters for a method (including uid if needed)</p>"
          }
        ]
      }
    },
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "error",
            "description": "<p>Contains non-null if error.</p>"
          },
          {
            "group": "Success 200",
            "type": "Object",
      ...
      "fields": {
        "Error 4xx": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "404",
            "description": "<p>Method not found.</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
            "field": "403",
            "description": "<p>Method requires more permissions</p>"
          },
          {
            "group": "Error 4xx",
            "optional": false,
            "field": "401",
            "description": "<p>Malformed parameters.</p>"
          }
        ]
      }
    },
    "version": "0.0.0",
    "filename": "src/api/trade/index.js",
    "groupTitle": "Trade"
  },
  {
    "type": "get",
    "url": "/trade/public/:method",
    "title": "Send general-scope request to Xchange",
    "name": "SendRequestPublic",
    "group": "Trade",
    "permission": [
      {
        "name": "public"
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "...",
            "description": "<p>parameters for a method</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "get",
    "url": "/trade/user/:method",
    "title": "Send authenticated request to Xchange",
    "name": "SendRequestUser",
    "group": "Trade",
    "permission": [
      {
        "name": "user",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "...",
            "description": "<p>parameters for a method (without uid)</p>"
          }
        ]
      }
    },
